...
# Source this file for development: source scripts/env-dev.sh

# Required Terraform variables - all must be set explicitly
...
if [[ -n "${TF_VAR_domain_name}" ]]; then
    export TF_VAR_domain_name="dev.${TF_VAR_domain_name}"
else
